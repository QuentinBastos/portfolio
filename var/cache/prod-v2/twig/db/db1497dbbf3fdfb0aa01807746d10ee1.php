...
class __TwigTemplate_0f1bfc632ae4705c77668a9a542f5737 extends Template
{
    ...
    <section id=\"works\" class=\"sectionWorks\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["project"]) {
            ...
            // line 50
            yield "            ";
            $context["loading"] = ((CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "first", [], "any", false, false, false, 50)) ? ("eager") : ("lazy"));
            // line 51
            yield "            <div id=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["project"], "slug", [], "any", false, false, false, 51), "html", null, true);
            ...
            yield "\" alt=\"\" class=\"centeredImage\" loading=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["loading"] ?? null), "html", null, true);
            yield "\" decoding=\"async\">
                <div class=\"project\">
                    <div class=\"leftSide\">
                        ";
            // line 55
            if (($context["next"] ?? null)) {
                // line 56
                yield "                            <a href=\"#";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["next"] ?? null), "slug", [], "any", false, false, false, 56), "html", null, true);
            ...
            yield "                    </div>
                    <div class=\"middleSide\">
                        <a href=\"";
            // line 68
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("project_show", ["slug" => CoreExtension::getAttribute($this->env, $this->source, $context["project"], "slug", [], "any", false, false, false, 68)]), "html", null, true);
            yield "\" aria-label=\"";
            ...
            yield "                                <pre class=\"language-css\">
                                    <img src=\"";
            // line 72
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(CoreExtension::getAttribute($this->env, $this->source, $context["project"], "icon", [], "any", false, false, false, 72)), "html", null, true);
            yield "\" alt=\"\" loading=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["loading"] ?? null), "html", null, true);
            yield "\" decoding=\"async\">
            ...
            yield "</span>
                    ...
                    <div class=\"rightSide\">
                        ";
            // line 81
            if (CoreExtension::getAttribute($this->env, $this->source, $context["project"], "featured", [], "any", false, false, false, 81)) {
                // line 82
            ...
            yield "</p>
                        <ul class=\"projectMeta\">
                            <li>";
            // line 86
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans(("project.origin." . CoreExtension::getAttribute($this->env, $this->source, $context["project"], "origin", [], "any", false, false, false, 86))), "html", null, true);
            yield "</li>
                            ";
            // line 87
            if (CoreExtension::getAttribute($this->env, $this->source, $context["project"], "year", [], "any", false, false, false, 87)) {
                yield "<li>";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans(CoreExtension::getAttribute($this->env, $this->source, $context["project"], "year", [], "any", false, false, false, 87)), "html", null, true);
                yield "</li>";
            }
            // line 88
            yield "                            ";
            if (CoreExtension::getAttribute($this->env, $this->source, $context["project"], "status", [], "any", false, false, false, 88)) {
                yield "<li>";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans(("project.status." . CoreExtension::getAttribute($this->env, $this->source, $context["project"], "status", [], "any", false, false, false, 88))), "html", null, true);
                yield "</li>";
            }
            // line 89
            yield "                        </ul>
            ...
            // line 90
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans((CoreExtension::getAttribute($this->env, $this->source, $context["project"], "key", [], "any", false, false, false, 90) . ".tagline")), "html", null, true);
            yield "</p>
                        <ul class=\"tagList\">
                            ";
            // line 92
            $context['_parent'] = $context;
            $context['_seq'] = CoreExtension::ensureTraversable(Twig\Extension\CoreExtension::slice($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["project"], "stack", [], "any", false, false, false, 92), 0, 5));
            ...
            yield "                        </ul>
                        <div class=\"projectActions\">
                            <a href=\"";
            // line 97
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("project_show", ["slug" => CoreExtension::getAttribute($this->env, $this->source, $context["project"], "slug", [], "any", false, false, false, 97)]), "html", null, true);
            yield "\"
...
";
    ...
    {
        return array (  388 => 113,  381 => 108,  374 => 107,  368 => 104,  348 => 98,  344 => 97,  340 => 95,  331 => 93,  327 => 92,  322 => 90,  319 => 89,  312 => 88,  306 => 87,  302 => 86,  296 => 84,  290 => 82,  288 => 81,  278 => 74,  271 => 72,  268 => 71,  259 => 70,  252 => 68,  248 => 66,  242 => 63,  238 => 62,  235 => 61,  229 => 58,  225 => 57,  220 => 56,  218 => 55,  210 => 52,  205 => 51,  202 => 50,  200 => 49,  197 => 48,  194 => 47,  191 => 46,  174 => 45,  168 => 42,  164 => 41,  160 => 40,  156 => 39,  152 => 38,  148 => 37,  138 => 30,  134 => 29,  126 => 26,  122 => 25,  118 => 24,  114 => 23,  104 => 16,  100 => 15,  93 => 11,  89 => 10,  85 => 9,  81 => 8,  77 => 6,  75 => 5,  72 => 4,  65 => 3,  53 => 2,  42 => 1,);
    }
