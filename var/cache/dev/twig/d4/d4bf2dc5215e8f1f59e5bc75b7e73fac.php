...
/* projects/chess.html.twig */
class __TwigTemplate_79089721bc50dcbacee3c0dbe9fc3cf5 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "projects/chess.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "projects/chess.html.twig"));

        $this->parent = $this->loadTemplate("base.html.twig", "projects/chess.html.twig", 1);
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        // line 4
        yield "    ";
        yield from $this->loadTemplate("header.html.twig", "projects/chess.html.twig", 4)->unwrap()->yield($context);
        // line 5
        ...
        yield "</h1>
            ...
            <span class=\"flex w-100 justify-center smallBaseSize mb-3\"><a href=\"https://github.com/QuentinBastos/chessJS\" class=\"hoverBlackA\" target=\"_blank\">";
        // line 10
        ...
        // line 21
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("chess.long_description"), "html", null, true);
        yield "</p>
                    </div>
                </div>
                <div class=\"wrapperDescription\">
        ...
        yield "</h2>
                <div class=\"flex flex-wrap justify-center\">
                    ";
        // line 52
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("chess.works"), "html", null, true);
        yield "
                </div>
            </div>
        </div>
...
";
    ...
    {
        return "projects/chess.html.twig";
    }
    ...
    {
        return array (  248 => 64,  235 => 63,  221 => 60,  208 => 59,  191 => 52,  186 => 50,  175 => 42,  168 => 38,  160 => 33,  153 => 29,  147 => 26,  139 => 21,  135 => 20,  126 => 14,  122 => 13,  116 => 10,  111 => 8,  106 => 5,  103 => 4,  90 => 3,  66 => 2,  43 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("{% extends 'base.html.twig' %}
{% block title2 %} - {{ \"chess.title\"|trans }}{% endblock %}
{% block body %}
    {% include \"header.html.twig\" %}
    <section class=\"projectView\">
        <div class=\"wrapperView\">
            <div class=\"titleProject\">
                <h1 class=\"middleBaseSize\">{{ \"chess.title\"|trans }}</h1>
            </div>
            <span class=\"flex w-100 justify-center smallBaseSize mb-3\"><a href=\"https://github.com/QuentinBastos/chessJS\" class=\"hoverBlackA\" target=\"_blank\">{{ \"view_git\"|trans }}</a></span>
            <div class=\"wrapperVideo\">
                <video class=\"video\" controls>
                    <source src=\"{{ asset('assets/video/chess.mp4') }}\" type=\"video/mp4\">
            ...
            <div class=\"wrapperInformation\">
                <div class=\"wrapperDescription\">
                    <div class=\"align-center flex flex-column h-100\">
                        ...
                        <p class=\"smallBaseSize\">{{ \"chess.long_description\"|trans }}</p>
                    </div>
                </div>
                <div class=\"wrapperDescription\">
                    <div class=\"align-center flex flex-column h-100\">
...
{% block stylesheets %}
    {{ parent() }}
{% endblock %}", "projects/chess.html.twig", "/home/ubuntu/Projects/portfolio/templates/projects/chess.html.twig");
    }
}
