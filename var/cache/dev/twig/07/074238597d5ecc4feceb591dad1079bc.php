...
{% block title2 %} - {{ \"interactive_book.title\"|trans }}{% endblock %}
{% block body %}
    ...
    <section class=\"projectView\">
        <div class=\"wrapperView\">
            ...
            <span class=\"flex w-100 justify-center smallBaseSize\"><a href=\"https://github.com/QuentinBastos/InteractiveBook\" class=\"hoverBlackA mb-3\" target=\"_blank\">{{ \"view_git\"|trans }}</a></span>
            <div class=\"wrapperVideo\">
                <video class=\"video\" controls>
